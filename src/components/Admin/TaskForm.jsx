...
function TaskForm({ User }) {
    ...
    const handlerSubmit = (e) => {
        ...
        let newTask = { taskTitle, taskDescription : taskDesc, taskDate, assignTo, category: taskCategory, active:false, newTask:true, failed:false, completed:false  }
        ...
        employee.forEach((elem) => {
            ...
            if(assignTo == elem.firstName){
                ...
                elem.tasks[elem.tasks.length -1 ].serialNO = elem.tasks.length - 1 
  ...
  return (
     <div className='p-5 bg-[#1c1c1c] pt-7 roounded'>
            <form 
            ...
            >
                <div className = "w-full md:w-1/2">
                    ...
                    <input 
                        ...
                        type = "date"  
                        className="text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border border-gray-400 mb-4 cursor-pointer"
                    />
                    </div>
                    <div>
